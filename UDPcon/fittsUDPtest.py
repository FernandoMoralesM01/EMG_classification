...
class SensorReceiver:
    def __init__(self, emg_port=50043, channel_list=list(range(8)), buffer_size=2000):
        ...
        self._data_socket.bind(('localhost', emg_port))
...
class Menu:
    def __init__(self):
        ...
        self.odh = OnlineDataHandler(shared_memory_items=receptor.shared_memory_items)
        self.odh.visualize()
    ...
    def initialize_ui(self):
        ...
        # Train Model Button
        Button(self.window, font=("Arial", 30), text = 'Get Training Data', command=self.launch_training).pack(pady=(0,20))
        # Start Isofitts
